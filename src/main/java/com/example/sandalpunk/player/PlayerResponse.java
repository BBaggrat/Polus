...
public record PlayerResponse(
        ...
        int coins,
        int experience,
        int levelProgressCurrent,
        int levelProgressTarget,
        int strength,
        int reaction,
        int analysis,
    ...
    public static PlayerResponse from(PlayerProfile playerProfile) {
        return new PlayerResponse(
                ...
                playerProfile.getExperience(),
                playerProfile.getCurrentLevelExperience(),
                playerProfile.getNextLevelExperience(),
                playerProfile.getStrength(),
                playerProfile.getReaction(),
                playerProfile.getAnalysis(),
                playerProfile.getAvailableStatPoints(),
